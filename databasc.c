...
void dataasc ( database * );
void tcasc ( database * );
void miscasc ( database * );
void adcasc ( database * );
void zoneasc ( database * );
void panelasc ( database * );
void faseasc ( database * );
void ticasc ( database * );
void bussasc ( database * );
void dcuasc ( database * );
void he0asc ( database * );
void he1asc ( database * );
void tctypeasc ( database * );

int zoneascr ( database * );
int he0ascr ( database * );
int he1ascr ( database * );
int faseascr ( database * );
int panelascr ( database * );
int adcascr ( database * );
int tctypeascr ( database * );
int tcascr ( database * );
int ticascr ( database * );
int bussascr ( database * );
int dcuascr ( database * );
int dataascr ( database * );
int miscascr ( database * );
