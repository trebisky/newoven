...
C tjt - heaven only knows what this is and why good old ATAN2
C  won't suffice.  I don't find this in the IRAF sources nor does
C  a google search turn it up.
C The following comment was in the original sources.
C ckdat2 is the IRAF name for ckdatan2()
C      double precision   ckdat2
...
C *** ckdat2
C      THXU = ckdat2(C,A)
C      THUV = ckdat2(D,B)-THXU
      THXU = datan2(C,A)
      THUV = datan2(D,B)-THXU
...
C *** ckdat2
C      THUS = ckdat2(D-C,B-A)-THXU
      THUS = datan2(D-C,B-A)-THXU
