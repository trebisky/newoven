...
C tjt - to avoid stupid warnings, I need to give IPL, IWP, and IPT
C  some dimension greter than 1
C      INTEGER            NDP,NT,NL,IER,IPT(1),IPL(1),IWL(1),IWP(1)
      INTEGER            NDP,NT,NL,IER, IWL(1)
      INTEGER            IPL(10), IWP(10), IPT(10)
C tjt - to avoid stupid warnings, I need to give XD and YD
C  some dimension greter than 1
C      DOUBLE PRECISION   XD(1),YD(1),WK(1)
      DOUBLE PRECISION   WK(1)
      DOUBLE PRECISION   XD(10),YD(10)
